defmodule Werewolf.Support.ActionsTestSetup do
  ...
  def players(_context), do: [players: %{"target" => %Player{name: "target", host: false, alive: true}}]

  def dead_players(_context), do: [dead_players: %{"target" => %Player{name: "target", host: false, alive: false}}]
end
