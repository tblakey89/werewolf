defmodule Werewolf.ActionRulesTest do
  ...
  describe "valid/3 summoner" do
    ...
    test "when able to summon, returns ok tuple", context do
      action = context[:summon_action]
    ...
    test "unable to summon for alive player", context do
      assert {:error, :invalid_target} ==
               ActionRules.valid(
                 context[:night_state],
                 context[:summoner],
    ...
    test "unable to summon when summoner is dead", context do
      assert {:error, :invalid_action} ==
               ActionRules.valid(
                 context[:night_state],
                 context[:dead_summoner],
                 context[:summon_action],
                 context[:players],
                 %Options{}
               )
    ...
    test "unable to summon in day phase", context do
      assert {:error, :invalid_action} ==
               ActionRules.valid(
                 context[:day_state],
                 context[:summoner],
    ...
    test "unable to summon when have wrong items", context do
      assert {:error, :invalid_action} ==
               ActionRules.valid(
                 context[:night_state],
                 context[:werewolf],
  ...
  describe "valid/3 werewolf_alpha" do
    setup [
      :bite_action,
      :player,
      :werewolf_alpha,
    ...
    test "when able to bite, returns ok tuple", context do
      action = context[:bite_action]

      assert {:ok, action} ==
               ActionRules.valid(
                 context[:night_state],
                 context[:werewolf_alpha],
                 action,
                 context[:players],
                 %Options{}
               )
    ...
    test "unable to bite when werewolf_alpha is dead", context do
      assert {:error, :invalid_action} ==
               ActionRules.valid(
                 context[:night_state],
                 context[:dead_werewolf_alpha],
                 context[:bite_action],
                 context[:players],
                 %Options{}
               )
